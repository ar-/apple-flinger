...
public class MissionM_1_4 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
		...
		// upper blocks
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.5218471f, 0.30607963f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.553901f, 0.30498973f, 0.5f, BodyType.DynamicBody));
		...
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.512065f, 3.9610732f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.5455685f, 3.6827009f, 0.5f, BodyType.DynamicBody));
