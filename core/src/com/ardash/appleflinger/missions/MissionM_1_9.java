...
import com.ardash.appleflinger.helpers.Calculator;
...
//		group.addActor( new BlockActor(world,MaterialConfig.STONE,x+0.5f,y+0.5f,1.2f,0.2f, BodyType.DynamicBody));  
	...
	public Group fillMirrorStage(GameWorld world) {
		...
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.65625f, 0.3095085f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.6406392f, 1.5153271f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.6574342f, 2.7254267f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.64214784f, 3.9362338f, 0.5f, BodyType.DynamicBody));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.1451294f, 2.9948468f, 0.5f, BodyType.DynamicBody));
