...
public class QuitDialog extends Dialog{
	...
	public QuitDialog() {
		super("", new WindowStyle(Assets.FontAsset.FLINGER_D64_B2_WB_DIAG_MINIL.font,Color.WHITE,new TextureRegionDrawable(Assets.SpriteAsset.DIALOG.get()))); //$NON-NLS-1$
		setModal(true);
		setMovable(false);
		setResizable(false);
