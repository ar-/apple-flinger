...
//		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.8397567f, 1.6875254f, 0.5f));
...
//		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.9124999f, 3.4049938f, 0.5f));
...
//		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.474419f, 3.9495397f, 0.5f));
		...
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.9346718f, 4.336325f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.8000002f, 3.4049993f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.8421941f, 1.6690935f, 0.5f));
