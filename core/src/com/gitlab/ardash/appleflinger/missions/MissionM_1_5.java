...
public class MissionM_1_5 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
		...
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 4.5508933f, 1.1313812f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.532829f, 1.2737975f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.3210675f, 0.56721085f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.3437505f, 1.9288769f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 0.6020787f, 3.078099f, 0.5f));
		group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 3.3090098f, 3.078296f, 0.5f));
