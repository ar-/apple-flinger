...
public class MissionM_2_5 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
        ...
        group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.540187f, 0.3050014f, 0.5f));
        ...
        group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.6105376f, 1.6276091f, 0.5f));
        group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.542138f, 0.9021744f, 0.5f));
