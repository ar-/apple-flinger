...
public class MissionM_1_1 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 2.3818345f, 1.9255339f, 0.5f));
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 3.5080411f, 1.4009242f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 4.5405188f, 0.8616436f, 0.5f));
