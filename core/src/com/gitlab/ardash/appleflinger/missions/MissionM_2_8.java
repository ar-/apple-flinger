...
public class MissionM_2_8 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
        ...
        group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.1072779f, 0.59113896f, 0.5f));
        ...
        group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 2.9721925f, 1.5667893f, 0.5f));
        group.addActor (new TargetActor(world, MaterialConfig.TARGET_L, 1.1897417f, 1.5586923f, 0.5f));
