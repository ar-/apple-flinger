...
public class MissionM_1_10 implements StageFiller{
	...
	public Group fillMirrorStage(GameWorld world) {
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 2.7410443f, 0.84295917f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.6441077f, 0.84436584f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 3.825703f, 0.8437609f, 0.5f));
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 2.3125129f, 1.3230667f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 3.407265f, 1.3297361f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 4.5061398f, 1.3263968f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.0688351f, 1.3545837f, 0.5f));
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 3.9450545f, 1.8722552f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 2.828975f, 1.8759879f, 0.5f));
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 1.7270491f, 1.8853937f, 0.5f));
		...
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 3.6618845f, 2.9423022f, 0.5f));
		group.addActor (new DorkActor(world, MaterialConfig.TARGET_L, 2.5874858f, 2.941448f, 0.5f));
